...
class TestPersonalAccountPage:
    def test_open_constructor_from_personal_account_page(self, login_successful):
    ...
    def test_click_logo_from_personal_account_page(self, login_successful):
        main_page = login_successful
        assert login_successful.is_login_successful()
    ...
    def test_logout_from_personal_account_page(self, login_successful):
        main_page = login_successful
        assert login_successful.is_login_successful()
